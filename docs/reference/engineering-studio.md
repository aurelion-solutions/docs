...
two tree views, plus a status bar item and a set of commands.
...
`aurelion.copyInstanceId`, and `aurelion.focusApplication` are internal —
bound to tree context menus and hidden from the command palette.
